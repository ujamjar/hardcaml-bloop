...
(* OASIS_START *)
(* DO NOT EDIT (digest: 274ed19cade7747c39e4d0dfcace273b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-bloop";
          synopsis = "Boolean tools for HardCaml";
          description =
            Some
              [
                 OASISText.Para
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cryptominisat", None);
                           FindlibPackage ("bdd", None);
                           FindlibPackage ("uutf", None);
                           FindlibPackage ("gg", None);
                           FindlibPackage ("vg", None)
                        ];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "hardcaml-bloop";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "HardCamlBloop"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "pcn_taut.ml"});
               Executable
                 ({
                     cs_name = "pcn_compl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "pcn_compl.ml"});
               Executable
                 ({
                     cs_name = "sat_const";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "sat_const.ml"});
               Executable
                 ({
                     cs_name = "sat_mul";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sat_mul.ml"});
               Executable
                 ({
                     cs_name = "sat_ban";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sat_ban.ml"});
               Executable
                 ({
                     cs_name = "sat_repair";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "sat_repair.ml"});
               Executable
                 ({
                     cs_name = "bdd_dynw";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "bdd_dynw.ml"});
               Executable
                 ({
                     cs_name = "bdd_adder";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "bdd_adder.ml"});
               Executable
                 ({
                     cs_name = "bdd_repair";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "bdd_repair.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-bloop.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-bloop";
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\222E\139\172\140\242\025\014o\130\208\151\229\129%\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
