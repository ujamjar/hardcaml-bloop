...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5e0bf495bfe58ec73c8e0ea573a8fd1f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "sat_mul.ml"});
               Executable
                 ({
                     cs_name = "sat_repair";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\168b5\190\017\197\224|\183\179\145v\200\193-\219";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
